export const HomeSectionContainer = `
    flex flex-col gap-3 xl:gap-6 bg-white/90 p-4 lg:p-5 xl:p-6 rounded-2xl
...
export const VersusTagStyle = `
    flex items-center justify-center font-black italic text-sm xl:text-lg
    rounded-full w-8 xl:w-10 h-8 xl:h-10 shrink-0 bg-white border border-neutral-200 text-neutral-400 shadow-sm 
`;
