...
export const HomeDashboard = () => {
  ...
  return (
    <div className="grid grid-cols-1 overflow-y-auto md:overflow-auto md:grid-cols-2 gap-8 pb-6 h-full">
      <div className={HomeSectionContainer}>
        <TeamsPreview />
      </div>
      <div className={HomeSectionContainer}>
        <div className="flex flex-col items-center gap-2">
          <span className="text-lg 2xl:text-xl font-black text-neutral-700 uppercase tracking-wide">
            {t("Home.PrepareBattle.Title")}
          </span>
          <div className="h-0.5 w-20 bg-neutral-500 rounded-full" />
        </div>
        <div className="flex flex-col md:flex-row items-center justify-center gap-3 xl:gap-4 w-full bg-neutral-50 p-2.5 xl:p-4 rounded-xl border border-neutral-200">
